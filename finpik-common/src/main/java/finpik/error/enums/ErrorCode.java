...
public enum ErrorCode {
    ...
    OAUTH2_AUTHORIZATION_FAIL("OAuth2 인증에 실패 했습니다.", "ATH-0003", HttpStatus.UNAUTHORIZED),
    INTERNAL_AUTHORIZATION_FAIL("인증에 실패했습니다. 관리자에게 문의해주세요", "ATH-0004", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    PROFILE_SEQUENCE_CANNOT_BE_NULL("프로필의 순번이 NULL일 수 없습니다.", "PRF-0008", HttpStatus.BAD_REQUEST),
    CREDITS_CANNOT_BE_NULL("프로필의 신용점수, 신용상태 둘다 NULL일 수 없습니다.", "PRF-0009", HttpStatus.BAD_REQUEST),
    OUT_OF_RANGE_CREDIT_GRADE_STATUS("신용점수에 맞는 신용 등급이 존재하지 않습니다.", "PRF-0010", HttpStatus.BAD_REQUEST),

    // Loan Product
    NOT_FOUND_LOAN_PRODUCT("대출 상품을 찾을 수 없습니다.", "LPD-0001", HttpStatus.NOT_FOUND),
    NOT_CONVERT_KAFKA_MESSAGE_LOAN_PRODUCT("카프카에서 받은 추천 대출 상품 메세지를 컨버팅할 수 없습니다.", "LPD-0002", HttpStatus.BAD_REQUEST),
    NOT_CONVERT_KAFKA_MESSAGE("카프카에 메세지를 보내기 위한 추천 대출 상품의 조건을 문자열로 변경이 실패했습니다.", "LPD-0003", HttpStatus.BAD_REQUEST),;
