...
public enum ErrorCode {
    ...
    METHOD_ARGUMENT_NOT_VALID_EXCEPTION("입력값 검증 실패", "METHOD_ARGUMENT_NOT_VALID_EXCEPTION",
    ...
    INVALID_EMPLOYMENT_INFO("직장인 선택시 관련 정보들이 전부 채워져야 합니다.", "PRF-0004", CustomHttpStatus.BAD_REQUEST),
    INVALID_NOT_EMPLOYMENT_INFO("직장인이 아닌데 관련 정보들이 채워져 있으면 안됩니다.", "PRF-0005", CustomHttpStatus.BAD_REQUEST),
    ...
    NOT_CONVERT_KAFKA_MESSAGE_LOAN_PRODUCT("카프카에서 받은 추천 대출 상품 메세지를 컨버팅할 수 없습니다.", "LPD-0002",
            CustomHttpStatus.BAD_REQUEST),
    NOT_CONVERT_KAFKA_MESSAGE("카프카에 메세지를 보내기 위한 추천 대출 상품의 조건을 문자열로 변경이 실패했습니다.", "LPD-0003",
            CustomHttpStatus.BAD_REQUEST),;
