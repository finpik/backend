...
class BindExceptionHandlerTest {
    ...
    void handleBindException() {
        ...
        // then
        assertAll(
            () -> assertThat(graphQLError.getMessage()).isEqualTo(bindException.getMessage()),
            () -> assertThat(extensions).isNotNull(),
            () -> assertThat(extensions.get("code")).isEqualTo(ErrorCode.BIND_EXCEPTION.getCode()),
            () -> assertThat(extensions.get("httpStatusErrorCode")).isEqualTo(ErrorCode.BIND_EXCEPTION.getStatus().name()),
            () -> assertThat(extensions.get("httpStatusCode")).isEqualTo(ErrorCode.BIND_EXCEPTION.getStatus().value())
        );
    }
