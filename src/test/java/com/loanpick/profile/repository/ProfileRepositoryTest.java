...
class ProfileRepositoryTest {
    ...
    void saveAndFindProfile() {
        ...
        assertAll(
            ...
            () -> assertThat(foundProfile.get().getLoanProductUsageCount()).isEqualTo(profile.getLoanProductUsageCount()),
            () -> assertThat(foundProfile.get().getTotalLoanUsageAmount()).isEqualTo(profile.getTotalLoanUsageAmount()),
            ...
            () -> assertThat(foundProfile.get().getLoanProductUsageStatus()).isEqualTo(profile.getLoanProductUsageStatus()),
