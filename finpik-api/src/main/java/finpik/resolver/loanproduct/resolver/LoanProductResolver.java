...
public class LoanProductResolver implements LoanProductApi {
    ...
    @Override
    @QueryMapping
    public LoanProductResult getLoanProduct(User userInput, @Argument Long loanProductId, @Argument Long profileId) {
        require(userInput);

        LoanProductDto loanProduct = getLoanProductUseCase.getLoanProduct(loanProductId, profileId);
